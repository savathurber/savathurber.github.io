...
I am an engineering student focused on design prototyping, environmental systems, and technical problem-solving. I use this space to document my deep-dives into mechanical structures, data analysis, and hardware development.

## 📁 Featured Projects
Click the links below (or use the navigation menu) to explore my detailed project breakdowns:

* [**Autonomous Marine Environmental Monitor**](/marine-monitor.html) - A physical, biodegradable tracking system.
* [**Renewable Energy Techno-Economic Analysis**](/energy-analysis.html) - Grid-scale facility financial and technical modeling.

---
*Feel free to explore my work or reach out via the [Contact Page](/contact.html).*
-->
